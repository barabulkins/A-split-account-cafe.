...
// ---- ПРЕСЕТЫ ----
const PRESETS = [
  { id: 1, title: "Медовик", model: "models/medovik.glb" },
  { id: 2, title: "Шарлотка", model: "models/sharlotka.glb" },
  { id: 3, title: "Хрустящие креветки", model: "models/shrimps.glb" },
];
...
function renderModel() {
  ...
  document.getElementById("view-left").onclick = () =>
