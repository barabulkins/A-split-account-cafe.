window.onload = function () {
  ...
  document.getElementById("tax").onclick = function () {
    let income = parseFloat(a);
    if (income <= 20000000) {
      let duty = (income * 0.94).toString();
      console.log(
        "При выручке до 20 млн ₽ ставки составляют: НДС 0%, УСН 6% от выручки. Выручка после вычета налогов равна " +
          duty +
          " ₽",
      );
    } else if (20000000 < income && income <= 2500000000) {
      let duty = (income * 0.89).toString();
      console.log(
        "При выручке от 20 до 250 млн ₽ ставки составляют: НДС 5%, УСН 6% от выручки.Выручка после вычета налогов равна " +
          duty +
          " ₽",
      );
    } else if (2500000000 < income && income <= 4500000000) {
      let duty = (income * 0.87).toString();
      console.log(
        "При выручке от 250 до 450 млн ₽ ставки составляют: НДС 7%, УСН 6% от выручки. Выручка после вычета налогов равна " +
          duty +
          " ₽",
      );
    } else if (4500000000 < income) {
      let duty = (income * 0.74).toString();
      console.log(
        "При выручке более 450 млн ₽ ставки составляют: НДС 20%, УСН 6% от выручки. Выручка после вычета налогов равна " +
          duty +
          " ₽",
      );
    }
